...
const AllUsers = () => {
  ...
  return (
    <div>
      ...
      <div className="overflow-x-auto border border-neutral-400 rounded-lg px-4 py-8">
                ...
                <td>
                  {user.role === "admin" ? (
                    ...
                    <button
                      ...
                      className="btn btn-md bg-customGreen "
                    >
                      <FaUsers className="text-customWhite text-2xl"></FaUsers>
                    </button>
                  )}
                </td>
                <td>
